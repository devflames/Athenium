          ...
          <div className="col-xxl-5 col-lg-6">
            <div className="section-text">
              ...
              <p className="mb-4 fs-five">
                Athenium Studios provides full-service game creation in
            ...
            <div className="content-item d-grid gap-6">
              <div className="content-box d-flex gap-4 gap-md-5">
                ...
                <div className="info-box">
                  ...
                  <p>
                    Athenium Gaming Studios creates games worldwide.
              ...
              <div className="content-box d-flex gap-4 gap-md-5">
                ...
                <div className="info-box">
                  ...
                  <p>
                    Athenium Gaming Studios wants to make games that raise your
              ...
              <div className="content-box d-flex gap-4 gap-md-5">
                ...
                <div className="info-box">
                  ...
                  <p>
                    Athenium values the efforts of independent game studios.
                    Developers with personal ambitions create the games.
                    Athenium Gaming Studios exists primarily to improve these
                    games.
                  </p>
                </div>
              </div>
