            ...
            <ul className="navbar-nav d-xl-flex d-none gap-3 py-4 py-lg-0 m-auto pe-20 align-self-center">
              <li className="dropdown show-dropdown">
                <button
                  ...
                  className={`dropdown-toggle dropdown-nav ${homepage ? "active" : ""
                    }`}>
                  Home
                </button>
              ...
              <li className="dropdown show-dropdown">
                <button
                  type="button"
                  aria-label="Navbar Dropdown Button"
                  className={`dropdown-toggle dropdown-nav ${(path == "/game" || path == "/game-details") && "active"
                    }`}>
                  games
                </button>
                <ul className="dropdown-menu">
